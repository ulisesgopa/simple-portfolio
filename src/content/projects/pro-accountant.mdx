---
title: Canal CNC La Unión Landing Page
summary: Web platform built for a local TV channel to provide 24/7 livestream access to their audience, including a cloud-hosted player and basic content pages.
tags:
    - React
    - Next.js
    - Tailwind
...
endDate: 2024-12-20
author: VicBoxWeb platform built for a local TV channel to provide 24/7 livestream access to their audience, including a cloud-hosted player and basic content pages.
